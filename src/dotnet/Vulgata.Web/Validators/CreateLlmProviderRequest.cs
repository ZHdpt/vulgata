...
public sealed class CreateLlmProviderRequest
{
...
public sealed class CreateLlmProviderRequestValidator : AbstractValidator<CreateLlmProviderRequest>
{
    ...
    public CreateLlmProviderRequestValidator()
    {
        ...
        RuleFor(request => request.ApiKey)
            .Must(value => !string.IsNullOrWhiteSpace(value)).WithMessage("API 密钥不能为空。")
